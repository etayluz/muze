...
+ (MBProgressHUD *)showHUDAddedTo:(UIView *)view message:(NSString*)message animated:(BOOL)animated {
...
- (void)layoutSubviews {
    ...
    NSDictionary* attribs2 = @{NSFontAttributeName:detailsLabel.font};
    CGSize detailsLabelSize = [detailsLabel.text sizeWithAttributes:attribs2];
//    NSStringDrawingContext *context = [[NSStringDrawingContext alloc] init];
//    context.minimumScaleFactor = 0.7;
//    CGSize detailsLabelSize =  [detailsLabel.text boundingRectWithSize:CGSizeMake(maxWidth, HUGE_VAL)
